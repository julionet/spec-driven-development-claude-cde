...
| RF-27 | O app deve iniciar a captura das coordenadas do dispositivo quando uma viagem for ativada. | P0 | US-08, US-09 |
...
| RF-31 | O app deve tentar enviar as coordenadas locais pendentes para o endpoint a cada 60 segundos quando houver conexão com a internet. | P0 | US-08, US-09 |
