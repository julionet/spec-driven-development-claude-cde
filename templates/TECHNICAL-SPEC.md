...
> **Tech Lead:** [Nome]  
> **Spec de Produto vinculada:** [PRODUCT-SPEC.md](./PRODUCT-SPEC.md)  
> **Plataforma:** `iOS` | `Android` | `iOS + Android`  
> **Linguagem / Framework:** [ex.: Swift / SwiftUI — Kotlin / Jetpack Compose]
...
|------------|--------|------------|---------|
| [Nome] | [X.Y.Z] | [O que faz] | [MIT / Apache / Comercial] |
